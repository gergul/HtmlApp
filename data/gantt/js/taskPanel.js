...
Ext.ns('Longboo');
Ext.define('Longboo.AssignmentGrid', {
...
Ext.define('Longboo.TaskAdvancePanel', {
			...
			},
			{
				...
				items: [
						...
						},
						{
							...
							layout: 'fit',
							scope: this,
							items: this.taskGrid = new Longboo.TaskGrid()
						...
						},
						{
							...
							layout: 'fit',
							scope: this,
							items: this.assignmentgrid = new Longboo.AssignmentGrid()
						},
						{
							xtype: 'panel',
							title: '高级',
...
Ext.define('Longboo.TaskDialog', {
	...
	buildComponents: function(){
		...
		return [{
			...
			activeItem: 0,
			items: me.taskAdvancePanel = new Longboo.TaskAdvancePanel(),
			buttons: [{
				text: '保存',
				handler: function () {
